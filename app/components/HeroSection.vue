  ...
  <section class="hero">
    <div class="container">
      <div class="hero-content">
        ...
        <p class="hero-sub">Focus profiles that open your apps, arrange your windows, kill distractions, and start a timer. One button.</p>
        <div class="hero-actions">
          <a href="https://github.com/Kurk3/lock-it-landing/releases/latest/download/Lock-it-1.0.0-universal.dmg" class="hero-cta" @click="trackDownload('hero')">
...
const modes = [
  { name: 'Deep Work', desc: 'VS Code, Terminal, Safari' },
  { name: 'Design', desc: 'Figma, Safari' },
  { name: 'Writing', desc: 'iA Writer' },
]
</script>
